...
// TODO Find the longest word, display it and its length
const longestWordOne = (str) => {
  const filteredWords = str.trim().split(" ");
  const words = [];
...
const longestWordTwo = (str) => {
  const wordsIteration1 = str.split("\n");
  const wordsIteration2 = [];
  for (let index = 0; index < wordsIteration1.length; index++) {
    wordsIteration2.push(...wordsIteration1[index].split(" "));
  }
  let longest = "";
  for (let index1 = 0; index1 < wordsIteration2.length; index1++) {
    if (wordsIteration2[index1].length > longest.length) {
      longest = wordsIteration2[index1];
    }
  }
  console.log(longest, longest.length);
};
...
console.timeEnd("longestWordOne");

console.log(" ");

console.time("longestWordTwo");
longestWordTwo(lorem1);
longestWordTwo(medium1);
console.timeEnd("longestWordTwo");
