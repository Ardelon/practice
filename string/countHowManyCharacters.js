...
const countHowManyCharactersOne = (str) => {
  const letters = {};
  ...
  console.log(str.length, totalLetterCount, letters);
};

console.time("countHowManyCharactersOne");
countHowManyCharactersOne(lorem1);
countHowManyCharactersOne(medium1);
console.timeEnd("countHowManyCharactersOne");
